...
ibeaconFilePath = '.\\ibeacon_mac_count_day13_16.csv'  # ibeacon统计文件目标路径及文件名
allPointCsvRootDir = '.\\csv_data'  # 总数据数据文件夹
# 样品数据集目标路径，可以设置为训练集或测试集
dp.sampleDataSetFilePath = '.\\rnn_sample_set_4days.csv'
